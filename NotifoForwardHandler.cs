...
namespace Notifo_Forwarder
{
    ...
    /// </remarks>
    public class NotifoForwardHandler : IForwardDestinationHandler
    {
        ...
        public List<Type> Register()
        {
            ...
            list.Add(typeof(NotifoDestination));
            return list;
        }
        ...
        {
            return new System.Drawing.Bitmap(Properties.Resources.notifo);
        }
    }
}
